...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnCreateCookie ( sName, sValue, iSecs, sBaseName, fnCallback )
		{
			 ...
			 */
			var aParts = window.location.pathname.split('http://themes.vivantdesigns.com/');
			...
			if ( fnCallback !== null )
			{
				...
				sFullCookie = fnCallback( sNameFile, oData, date.toGMTString(),
					aParts.join('http://themes.vivantdesigns.com/')+"/" );
			}
			else
			{
				sFullCookie = sNameFile + "=" + encodeURIComponent(sValue) +
					"; expires=" + date.toGMTString() +"; path=" + aParts.join('http://themes.vivantdesigns.com/')+"/";
			}
		...
		{
			var
				aParts = window.location.pathname.split('http://themes.vivantdesigns.com/'),
